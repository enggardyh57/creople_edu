                            ...
                            <form class="user" method="post" action="<?php echo base_url('registrasi/index');?>">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                        ...
                                        <?php echo form_error('nama','<div class="text-danger 
                                        small ml-2">','</div');?>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="buat password" name="password_1">
                                            <?php echo form_error('password_1','<div class="text-danger 
                                        small ml-2">','</div');?>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
